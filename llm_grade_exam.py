...
def main():
    ...
    parser.add_argument("--llm-grade-dir-name", default="llm_grade", type=str)
    ...
    if args.with_ref == 'no':
        out_dir = f"{args.llm_grade_dir_name}/{exam_name}/grader_{args.llm_name}/{args.nr_shots}_shot"
    elif args.with_ref == 'yes':
        out_dir = f"{args.llm_grade_dir_name}/{exam_name}/grader_{args.llm_name}/{args.nr_shots}_shot_with_ref"
    else:
