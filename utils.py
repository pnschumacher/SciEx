...
LLM_LIST = ['llava', 'mistral', 'mixtral', 'qwen', 'claude', 'gpt35', 'gpt4v', 'o1-mini', 'llama3.3', 'llama3.3_cm', 'qwen2.5', 'qwen2.5_cm', 'llama3.3_transcript', 'qwen2.5_transcript']
EXAM_LIST = [
...
def get_index_and_client(exam_json_path, embedding_model_name, embedding_model_path, course_material_path, course_material_type, vector_db_path):
    ...
    embed_model = HuggingFaceEmbedding(model_name=embedding_model_name, cache_folder=embedding_model_path)
